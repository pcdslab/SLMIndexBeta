                                   ...
                                   CometSearchManager &searchMgr)
{
   ...
   fprintf(fpout, "H\tSQTGenerator\tSAPPHIRE\n");
   fprintf(fpout, "H\tComment\tCSAPPHIREVersion %s\n", comet_version);
   fprintf(fpout, "H\n");
   ...
   while ((pStr = strrchr(szMod, '=')) != NULL)
   {
      ...
      {
         /* HM: Originally, it was *pStr--; which is same as pStr--;
          * TODO: Did the programmer want to do a *pStr -= 1 ?? */
         pStr--;
