...
#define MAX_FRAGMENT_CHARGE         3
#define MAX_PRECURSOR_CHARGE        5

#define SPARSE_MATRIX_SIZE          100

/************************ HM: ***************************/
/* HM: Number of peaks in the spectra.
 * TODO: Make it configurable */
#define NUM_PEAKS                   80
#define FRAGS                       100
/* HM: Macro to avoid compiler warning if a param is unused */
#define iMSQ_UNUSUED_PARAM(x)       (void) x
#define SAPPHIRE_UNUSUED_PARAM(x)   iMSQ_UNUSUED_PARAM(x)

/* HM: Get the bin index according to dF in the transformed data */
#define SCALE(x)                    (x)

/* HM: Tolerance for fragment when searching */
#define deltaF                      1

/* HM: In CometPreprocess.cpp where the windows are being created to normalize
 *     the intensities of the fragments in that mass window */
#define NUM_WINDOWS                 10

/* Number of characters */
#define FIRSTROW_CHARS              256

/* Max Daltons for fragmensts */
#define MAX_RANGE                   65536

/* The max. number of sequences in the sequence database */
#define ALLOWED_SEQUENCES           (UINT)32000000*64/NUM_PEAKS

/* Set/get the bit for modification */
...
/* HM: TODO: Control for Only peptide count required.
 * 0 MEANS only num_peps
 * 1 MEANS will preprocess
 */
#define PREPROCESS                1
#define PTHREADING

/* HM: Look for Pattern_Search position modulos */
#undef POSITION

/* HM: Search via SA or BWA */
#define SEARCH_SA
#undef SEARCH_BWA

/* TODO: VAR MOD SEARCH */
#define VARMOD_SEARCH
