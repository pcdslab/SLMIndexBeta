...
#define comet_version   "2018.07 Beta 0.7"
#define copyright "   Florida International University"
...
#ifdef DESCENDING
void mergeSortD(int array[], int aux[], int left, int right);
void mergeD(int array[], int aux[], int left, int right);
#endif
